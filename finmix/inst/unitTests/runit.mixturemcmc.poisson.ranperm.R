...
".setUp.data.ranperm" <- function(withInd = FALSE) {
        ## Get path ##
        pkg <- "finmix"
...
".setUp.model.ranperm" <- function() {
        model <- model(dist. = "poisson", K. = 2)
        return(model)
}

".setUp.mcmc.ranperm" <- function() {
...
### --- Test functions --- ###
"test.FIX.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
        set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
	...
	checkTrue(identical(class(mcmcout)[1], "mcmcoutputfix"), "check1")
        checkTrue(mcmcout@ranperm == TRUE, "check2")
...
"test.FIX.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
        model <- .setUp.model.ranperm()
        setIndicfix(model) <- TRUE
	prior <- prior(hier = FALSE)
        prior <- priordefine(data, model, varargin = prior)
...
"test.FIX.HIER.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
...
"test.FIX.HIER.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.FIX.HIER.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.FIX.POST.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
...
"test.FIX.POST.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.FIX.POST.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.FIX.HIER.POST.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
...
"test.FIX.HIER.POST.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.FIX.HIER.POST.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.HIER.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.HIER.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.HIER.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.POST.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
...
"test.IND.POST.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
	...
	for(s in 1:mcmc@storeS) {
		checkTrue(!any(is.na(mcmcout@S[, s])), 
			paste("check", 38 + m * (k - 1) + k, sep = ""))
		checkTrue(all(abs(mcmcout@S[, s] 
			- mean(mcmcout@S[, s])) > 0),
			paste("check", 39 + m * (k - 1) + k, sep = ""))
	}
	checkEquals(nrow(mcmcout@NK), mcmc@M)
	checkEquals(ncol(mcmcout@NK), model@K)
	m <- 2
...
"test.IND.POST.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.HIER.POST.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = FALSE)
...
"test.IND.HIER.POST.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)
...
"test.IND.HIER.POST.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
    set.seed(0)
        data <- .setUp.data.ranperm(withInd = TRUE)

...
".setUp.model.startpar.ranperm" <- function() {
        model <- model(dist = "poisson", K = 2)
        return(model)
}

".setUp.mcmc.startpar.ranperm" <- function() {
...
### --- Test functions --- ###
"test.FIX.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
...
"test.FIX.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
...
"test.FIX.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
".test.FIX.HIER.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = FALSE)
...
".test.FIX.HIER.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
 	set.seed(0)       
      	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
".test.FIX.HIER.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
 	set.seed(0)       
        data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.FIX.POST.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
 	set.seed(0)       
        data <- .setUp.data.startpar.ranperm(withInd = FALSE)
...
"test.FIX.POST.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.FIX.POST.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.FIX.HIER.POST.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = FALSE)
...
"test.FIX.HIER.POST.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.FIX.HIER.POST.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: TRUE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.IND.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: FALSE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = FALSE)
...
"test.IND.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: FALSE
	set.seed(0)
        data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.IND.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
	set.seed(0)
        data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.IND.POST.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.IND.HIER.POST.STARTPAR.RANPERM.1"  <- function() {
        ## Setting:
        ##      indicfix: FALSE
 	set.seed(0)       
        data <- .setUp.data.startpar.ranperm(withInd = FALSE)
...
"test.IND.HIER.POST.STARTPAR.RANPERM.2" <- function() {
        ## Setting:
        ##      indicfix: FALSE
        set.seed(0)
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)
...
"test.IND.HIER.POST.STARTPAR.RANPERM.3" <- function() {
        ## Setting:
        ##      indicfix: FALSE
       	set.seed(0)       
	data <- .setUp.data.startpar.ranperm(withInd = TRUE)

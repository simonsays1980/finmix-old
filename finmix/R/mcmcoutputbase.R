...
setMethod( "plotHist", signature( x   = "mcmcoutputbase", 
           ...
           function( x, dev = TRUE, ... ) 
           {
               ...
               if ( dist == "poisson" ) {
                   ...
                   .hist.Normal.Base( x, dev )                   
               } else if ( dist == "student" ) {
                   .hist.Student.Base( x, dev )
               } else if ( dist == "normult" ) {
                   .hist.Normult.Base( x, dev )
               } else if ( dist == "studmult" ) {
                   .hist.Studmult.Base( x, dev )
               }
           }
)
...
setMethod( "plotDens", signature( x   = "mcmcoutputbase",
           ...
           function(x, dev = TRUE, ... )
           {
               ...
               if ( dist == "poisson" ) {
                   ...
                   .dens.Normal.Base( x, dev )                   
               } else if ( dist == "student" ) {
                   .dens.Student.Base( x, dev )
               } else if ( dist == "normult" ) {
                   .dens.Normult.Base( x, dev )
               } else if ( dist == "studmult" ) {
                   .dens.Studmult.Base( x, dev )
               }

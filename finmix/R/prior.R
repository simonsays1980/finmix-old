               ...
               if ( dist == "poisson" ) {
                   ...
                   if ( dist == "student" || dist == "studmult" ) {
                        ...
                        warning( paste( "A 'prior' object for a Student-t model ",
                                        ...
                                        "of the 'prior' object. Call the function ", 
                                        "setMHTune() to add this vector to the prior.", sep = "" ), 
                                 call. = FALSE )
                   }
               }
...
setReplaceMethod( "setMHTune", "prior", 
                  function( object, value )
                  {                       
                      object@par$df$mhtune <- value
                      validObject( object )
                      return( object )
                  }
)
